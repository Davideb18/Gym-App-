       ...
       <BlurView intensity={100} tint="dark" className="flex-1">
          ...
          <ScrollView className="flex-1 pt-16 px-6" showsVerticalScrollIndicator={false}>
             ...
             <View className="items-center mb-8">
                ...
                <Text className="text-white text-3xl font-black tracking-tighter text-center uppercase">Ottimo Lavoro!</Text>
                <Text className="text-gray-400 font-bold mt-2 text-center text-sm">
                   Hai appena polverizzato la routine "{summaryData.routineName}"
                </Text>
             </View>
             ...
             <View className="gap-y-4 mb-8">
                ...
                <View className="bg-black/40 rounded-[32px] p-6 border border-white/5 flex-row items-center justify-between shadow-inner">
                   <View>
                     <Text className="text-gray-500 font-bold text-xs uppercase tracking-widest mb-1">Durata Allenamento</Text>
                ...
                <View className="flex-row gap-x-4">
                   <View className="flex-1 bg-black/40 rounded-[32px] p-6 border border-white/5 shadow-inner">
                     ...
                     <Text className="text-gray-500 font-bold text-[10px] uppercase tracking-widest mt-1">Totale Serie</Text>
                   </View>
                   ...
                   <View className="flex-1 bg-[#10B981]/10 rounded-[32px] p-6 border border-[#10B981]/30 shadow-inner">
                     ...
                     <Text className="text-[#10B981]/60 font-bold text-[10px] uppercase tracking-widest mt-1">Volume Kg</Text>
                   </View>
                </View>
             </View>
             ...
             <View className="bg-black/60 rounded-[32px] p-6 mb-8 border border-white/5 items-center">
                <Text className="text-white font-black text-lg mb-4 text-center tracking-tight">Mappa Muscolare</Text>
                {/* Dummy Figure */}
                <View className="w-full h-48 bg-white/5 rounded-2xl border border-dashed border-white/10 items-center justify-center">
                   ...
                   <Text className="text-gray-500 font-bold text-xs uppercase tracking-widest text-center">Modello 3D in arrivo</Text>
                   <Text className="text-[#10B981] text-[10px] font-black mt-2 bg-[#10B981]/20 px-3 py-1 rounded-full uppercase">Pettorali - Tricipiti</Text>
                </View>
             </View>

             {/* LISTA ESERCIZI & PR */}
             <View className="mb-10">
                <Text className="text-gray-400 font-black text-xs uppercase tracking-[4px] mb-4 ml-2">Progressi</Text>
                   ...
                   <View key={idx} className="bg-black/40 p-4 rounded-2xl mb-3 flex-row items-center justify-between border border-white/5">
                      ...
                      {idx % 2 === 0 ? (
                         <View className="bg-yellow-500/20 px-2 py-1 rounded border border-yellow-500/30 flex-row items-center">
                            ...
                            <Text className="text-yellow-500 font-black text-[10px] ml-1 uppercase">Nuovo PR!</Text>
                         </View>
                      ) : (
                         <View className="bg-white/5 px-2 py-1 rounded border border-white/5">
                            <Text className="text-gray-500 font-black text-[10px] uppercase">Mantenuto</Text>
                         </View>
                      )}
                   </View>
                ))}
          ...
          <View className="absolute bottom-0 left-0 right-0 p-6 pb-10 flex-row justify-between bg-black/60 border-t border-white/10 backdrop-blur-md">
             ...
             >
                <Text className="text-black font-black uppercase tracking-widest text-base">Chiudi e Salva</Text>
             </TouchableOpacity>
          </View>
